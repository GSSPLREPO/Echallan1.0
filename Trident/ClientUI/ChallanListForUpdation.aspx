<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster/MainMaster.Master" AutoEventWireup="true" CodeBehind="ChallanListForUpdation.aspx.cs" Inherits="Trident.ClientUI.ChallanListForUpdation" %>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="panel-heading">
                            <div class="col-md-10">
                                <h4>
                                    <asp:Label ID="lblHeading" runat="server" Text="List of Challan for Updation"></asp:Label></h4>
                            </div>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ScriptDeclaration" runat="server">
    <script src="../codejs/ListForUpdation.js"></script>
