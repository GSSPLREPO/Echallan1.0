<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster/MainMaster.Master" AutoEventWireup="true" CodeBehind="DiscardedChallanReport.aspx.cs" Inherits="Trident.Reports.DiscardedChallanReport" %>
                ...
                <div class="row" style="overflow: scroll;">
                    <asp:GridView runat="server" ID="gvPendingChallanReport" CssClass="table table-hover table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="DiscardedDate" HeaderText="Discarded Date" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="Name" HeaderText="Discarded By" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" />
