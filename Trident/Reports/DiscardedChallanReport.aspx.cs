...
{
    public partial class DiscardedChallanReport : PageBase
    {
        #region Declaration
        ...
        #region Page Base
        public DiscardedChallanReport() : base(0)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["ScreenRights"] != null)
                {
                    ...
                    if (dataTable.Contains("DiscardedChallanReport") == false)
                    {
            ...
            {
                log.Error("Page_Load Discarded Challan Report", ex);
        ...
        //new Regex("(\\S+)\\.\\.(\\S+)", RegexOptions.IgnoreCase | RegexOptions.CultureInvariant | RegexOptions.Compiled);
        //----------------------------------------------------------------------- 
        protected void btnGo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objResult = new ReportBL().GetDiscardedChallanReport(dtFromDateTime, dtToDateTime);
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string filename = "DiscardedChallan_Report" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".xls";
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string text2 = "DISCARDED CHALLAN REPORT";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        //string content = "<table border='1' style='display: table;width: 100px; clear:both;'> <tr> <th colspan='3' style='float: center;'><div align='center'><strong>From Date: </strong>" + txtFromDate.Text + "<strong> To Date: </strong>"+ txtToDate.Text + "</div></th> </tr></table>";


                        //content += "<th align='left' style=''><strong> To Date: </strong>" + //colspan='4' 
                        //txtToDate.Text + "</th>" +
                        ...
                        PdfPCell headerCell03 = new PdfPCell(new Phrase("Total Discarded Challans"));
                        ...
                        // PdfPTable pdfPTable = new PdfPTable(gvMilkReception.HeaderRow.Cells.Count - 2);
                        ...
                        if (gvPendingChallanReport != null && gvPendingChallanReport.Rows.Count > 0)
                        {
                            ...
                            PdfPCell headerCell5 = new PdfPCell(new Phrase("Discarded Date"));
                            ...
                            PdfPCell headerCell6 = new PdfPCell(new Phrase("Discarded By"));
                            ...
                            Response.AddHeader("content-disposition", "attachment;" + "filename=DiscardedChallanReport" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf");
                            Response.Cache.SetCacheability(HttpCacheability.NoCache);
