<%@ Page Language="C#" MasterPageFile="~/MainMaster/MainMaster.Master" AutoEventWireup="true" CodeBehind="PendingChallanReport.aspx.cs" Inherits="Trident.Reports.PendingChallanReport" %>
            ...
            <div class="panel-heading">
                <div class="row">
                    ...
                    <div class="col-md-2 right" id="divExport" runat="server">
                        <asp:LinkButton ID="imgPDFButton" ClientIDMode="Static" runat="server" OnClick="imgbtnPDF_OnClick" CssClass="btn btn-danger quick-btn"><i class="fa fa-file-pdf-o fa-2x"></i></asp:LinkButton>
                        <%--<asp:LinkButton ID="imgExcelButton" runat="server" OnClick="imgbtnExcel_OnClick" CssClass="btn btn-success quick-btn"><i class="fa fa-file-excel-o fa-2x"></i></asp:LinkButton>--%>
                    </div>
                </div>
            </div>
