...
{
    public partial class PendingChallanReport : PageBase
    {
        #region Declaration
        ...
        #region Page Base
        public PendingChallanReport() : base(0)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["ScreenRights"] != null)
                {
                    ...
                    if (dataTable.Contains("PendingChallanReport") == false)
                    {
            ...
            {
                log.Error("Page_Load Pending Challan Report", ex);
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if (dtFromDateTime <= dtToDateTime)
                {
                    ...
                    //string rootLPImgPath = ResolveUrl(objResult.resultDT.Rows[1]["LPImage"].ToString()); //"~/Mathi/Images/"
                    ...
                    if (gvPendingChallanReport.Rows.Count > 0)
                    {
                        ...
                        imgPDFButton.Visible = divId.Visible = true;
                        divExport.Visible = true;
                        divId.Visible = false;
                    }
                    else
                    {
                        imgPDFButton.Visible = divId.Visible = false;
                        divExport.Visible = false;
                        divId.Visible = true;
        ...
        protected void imgbtnExcel_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                Response.Charset = "";
                string FileName = "PendingChallan" + DateTime.Now + ".xls";
                StringWriter strwritter = new StringWriter();
                HtmlTextWriter htmltextwrtter = new HtmlTextWriter(strwritter);
                Response.Cache.SetCacheability(HttpCacheability.NoCache);
                Response.ContentType = "application/vnd.ms-excel";
                Response.AddHeader("Content-Disposition", "attachment;filename=" + FileName);
                gvPendingChallanReport.GridLines = GridLines.Both;
                gvPendingChallanReport.HeaderStyle.Font.Bold = true;
                gvPendingChallanReport.RenderControl(htmltextwrtter);
                ...
                //string filename = "PendingChallan_Report" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".xls";
                //Response.AddHeader("content-disposition", "attachment;filename=" + filename);
                //Response.Cache.SetCacheability(HttpCacheability.NoCache);
                ...
                //string strSubTitle = "PENDING CHALLAN REPORT";
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string text2 = "PENDING CHALLAN REPORT";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        PdfPCell headerCell03 = new PdfPCell(new Phrase("Total Pending Challans"));
                        ...
                        PdfPCell headerCell5 = new PdfPCell(new Phrase("Due Date"));
                        ...
                        PdfPCell headerCell6 = new PdfPCell(new Phrase("Prepared By"));
                        ...
                        Response.AddHeader("content-disposition", "attachment;" + "filename=PendingChallanReport" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf");
                        Response.Cache.SetCacheability(HttpCacheability.NoCache);
