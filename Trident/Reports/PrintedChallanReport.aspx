<%@ Page Title="" Language="C#" MasterPageFile="~/MainMaster/MainMaster.Master" AutoEventWireup="true" CodeBehind="PrintedChallanReport.aspx.cs" Inherits="Trident.Reports.PrintedChallanReport" %>
                ...
                <div class="row" style="overflow: scroll;">
                    <asp:GridView runat="server" ID="gvPendingChallanReport" CssClass="table table-hover table-striped"
                        ...
                        <Columns>
                            ...
                            <asp:BoundField DataField="PrintDate" HeaderText="Printed Date" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" />
                            <asp:BoundField DataField="Name" HeaderText="Printed By" ItemStyle-Wrap="false" ItemStyle-HorizontalAlign="Center" />
