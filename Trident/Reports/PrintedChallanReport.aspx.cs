...
{
    public partial class PrintedChallanReport : PageBase
    {
        #region Declaration
        ...
        #region Page Base
        public PrintedChallanReport() : base(0)
        {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            try
            {
                ...
                if (Session["ScreenRights"] != null)
                {
                    ...
                    if (dataTable.Contains("PrintedChallanReport") == false)
                    {
            ...
            {
                log.Error("Page_Load Printed Challan Report", ex);
        ...
        protected void btnGo_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                {
                    objResult = new ReportBL().GetPrintedChallanReport(dtFromDateTime, dtToDateTime);
        ...
        protected void imgbtnPDF_OnClick(object sender, EventArgs e)
        {
            try
            {
                ...
                string text2 = "PRINTED CHALLAN REPORT";
                ...
                using (StringWriter sw = new StringWriter())
                {
                    using (HtmlTextWriter hw = new HtmlTextWriter(sw))
                    {
                        ...
                        PdfPCell headerCell03 = new PdfPCell(new Phrase("Total Printed Challans"));
                        ...
                        if (gvPendingChallanReport != null && gvPendingChallanReport.Rows.Count > 0)
                        {
                            ...
                            PdfPCell headerCell5 = new PdfPCell(new Phrase("Printed Date"));
                            ...
                            PdfPCell headerCell6 = new PdfPCell(new Phrase("Printed By")); //UserName
                            ...
                            Response.AddHeader("content-disposition", "attachment;" + "filename=PrintedChallanReport" + DateTime.Now.Date.ToString("dd-MM-yyyy") + ".pdf");
                            Response.Cache.SetCacheability(HttpCacheability.NoCache);
